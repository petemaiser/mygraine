//
//  HeadachesTableViewController.m
//  MyGraine
//
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"HeadachesTableViewCell" forIndexPath:indexPath];
    return cell;
}
...
{
    if ([[segue identifier] isEqualToString:@"showHeadacheDetail"]) {
        HeadacheDetailTableViewController *vc = (HeadacheDetailTableViewController *)[segue destinationViewController];
        if (vc) {
            vc.headache = YES;
        }
    }
