...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ReportsTableViewCell" forIndexPath:indexPath];
    return cell;
}
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if ([[segue identifier] isEqualToString:@"showReportDetail"]) {
        ReportDetailTableViewController *vc = (ReportDetailTableViewController *)[segue destinationViewController];
        if (vc) {
